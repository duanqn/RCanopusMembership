...
class Exception{
    ...
    const static int EXCEPTION_POLL = EXCEPTION_RECV + 1;
    const static int EXCEPTION_MESSAGE_INVALID_VERSION = EXCEPTION_POLL + 1;
    ...
    const static int EXCEPTION_MESSAGE_INVALID_REQUEST_TYPE = EXCEPTION_PREPREPARE_MISSING + 1;
    const static int EXCEPTION_CYCLE_NOT_IN_ROUND3 = EXCEPTION_MESSAGE_INVALID_REQUEST_TYPE + 1;
    const static int EXCEPTION_UNEXPECTED_CYCLE_STATE = EXCEPTION_CYCLE_NOT_IN_ROUND3 + 1;
    const static int EXCEPTION_NO_ENVOY_SELECTED = EXCEPTION_UNEXPECTED_CYCLE_STATE + 1;
    const static int EXCEPTION_PIPE_CREATION = EXCEPTION_NO_ENVOY_SELECTED + 1;
    const static int EXCEPTION_RETRY_NOT_IMPLEMENTED = EXCEPTION_PIPE_CREATION + 1;
};
